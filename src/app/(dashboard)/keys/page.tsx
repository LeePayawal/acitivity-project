      ...
      <div className="flex justify-center mb-4">
        <div className="h-16 w-16 flex items-center justify-center rounded-full bg-gradient-to-tr from-indigo-500 to-blue-400 shadow-lg">
          <svg xmlns="http://www.w3.org/2000/svg" 
               ...
               stroke="currentColor" 
               strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 11c0-1.657 1.343-3 3-3h1a3 3 0 110 6h-1a3 3 0 01-3-3zM9 17H7a5 5 0 01-5-5V9a5 5 0 015-5h2m4 0h2a5 5 0 015 5v3a5 5 0 01-5 5h-2m-4 0v2a2 2 0 002 2h2a2 2 0 002-2v-2m-4 0h4" />
          </svg>
        </div>
      </div>
      ...
      <p className="text-gray-600 mb-6">
        ...
        <div className="mx-auto max-w-4xl space-y-6 p-6">
            ...
            <div className="flex gap-2">
             <Link href={"/docs"}>
              <Button variant={"outline"} className="flex items-center gap-2 text-gray-700 hover:text-gray-900 border-gray-200 hover:bg-gray-50" aria-label="Open API GUIDE">
               <BookOpenText />
     ...
     <div className="rounded-lg border border-blue-200 bg-blue-50/50 p-4 shadow-sm">
        ...
        <div className="mt-2 flex items-center gap-2 bg-white rounded-md p-3 border">
            <code className="text-sm break-all font-mono text-gray-700 flex-1">
                {/*API key will be displayed here */}
                {sampleApiKey}
                </code>
            <CopyButton value={sampleApiKey}/>
        </div>
        <p className="text-blue-700 mt-2 text-xs"> Save this key securely. You won't be able to see it again.</p>
     </div>
    </CardContent>
        </Card>
    <Card className="bg-white/70 backdrop-blur-sm border-white/20 shadow-lg">
  ...
  <TableBody>
    ...
    <TableCell className="text-gray-800 font-medium">Name of Key</TableCell>
      ...
      <TableCell>
        ...
        <Badge variant={"secondary"} className="bg-red-100 text-red-800 border-red-200">Revoked </Badge>
        </TableCell>
    ...
    <TableCell 
     ...
     className="text-muted-foreground text-center text-sm"
       ...
       <p className="text-amber-800">TIP: Call secured endpoints with the <code className="bg-amber-100 px-2 py-1 rounded text-amber-900 font-mono">x-api-key</code> header, See {" "}
       <Link className={"underline text-amber-700 hover:text-amber-900 font-medium"} href={"/docs"}>
       Docs
       </Link> 
       </p>
       </div>
